...
if(strcmp($_REQUEST['dropdown_name'], 'moduleList') == 0
  OR strcmp($_REQUEST['dropdown_name'], 'moduleListSingular') == 0
  OR strcmp($_REQUEST['dropdown_name'], 'moduleListGender') == 0) {
...
//MADCAP CHANGES
$smarty->display("custom/modules/Studio/DropDowns/EditView.tpl");
