...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
      ...
      <p>{$MOD.LBL_RENAME_TAB_WELCOME}
        <br/><font color="Red">Remember to <a href="index.php?action=QuickRepairAndRebuild&subaction=repairAndClearAll&module=Administration&repair_module[]=All+Modules&selected_actions[]=clearTpls&selected_actions[]=clearJsFiles&selected_actions[]=clearVardefs&selected_actions[]=clearJsLangFiles&selected_actions[]=clearDashlets&selected_actions[]=clearSugarFeedCache&selected_actions[]=rebuildAuditTables&selected_actions[]=rebuildExtensions&selected_actions[]=clearLangFiles&selected_actions[]=clearSearchCache&selected_actions[]=repairDatabase">Rebuild</a> afterwards</font>
      </p>
      <br/>
      {$buttons}
          ...
          <td colspan='2'>
            {if empty($newDropDown)}
              <form method='post' action='index.php' name='dropdownsform'>
                <input type='hidden' name='action' value='dlp_wizard'>
                <input type='hidden' name='wizard' value='madcap_EditDropDownWizard'>
