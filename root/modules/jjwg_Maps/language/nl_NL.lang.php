...
$mod_strings['LBL_GEOCODED_COUNTS_DESCRIPTION'] = 'De tabel hieronder geeft een overzicht van het aantal modulen ge-geocodeerd, gegroepeerd per geocoding response. '. 
'Let op het standaard gebruik van Google Maps is maximaal 2500 verzoeken per dag. '.
'Deze module zal een adres cache van geocoding informatie opbouwen op deze manier wordt het aantal verzoeken bij Google Maps tot een minimum beperkt.';
$mod_strings['LBL_CRON_URL'] = 'CRON URL';
$mod_strings['LBL_CRON_INSTRUCTIONS'] = 'Voor de verwerking van de geocoding verzoeken is het aanbevolen s nachts een Cron-Job te draaien. '.
'Een speciaal entry point is gemaakt en kan worden benadert zonder verificatie. '.
'De URL hieronder is bedoelt te gebruiken in combinatie met een Administratieve geplande taak. '.
'Kijk in de SugarCRM documentatie voor meer informatie.';
$mod_strings['LBL_EXPORT_ADDRESS_URL'] = 'Exporteer URLs';
$mod_strings['LBL_EXPORT_INSTRUCTIONS'] = 'Gebruik de links hieronder om de volledige adressen te exporteren, waar geocodeing informatie ontbreekt. '.
'Daarna gebruik een online of offline batch geocoding tool om de geocode adressen te verwerken. '.
'Wanneer het geocoding klaar is, importeer de adressen in de Adres Cache module zodat ze gebruikt kunnen worden met de kaarten.'.
'Opmerking, de Adres Cache module is optioneel. Alle geocoding informatie wordt bewaard in daarvoor aangewezen module.';
...
$mod_strings['LBL_CONFIG_ADDRESS_TYPE_FOR_CASES'] = 'Adres type voor Klachten:';
...
$mod_strings['LBL_CONFIG_GROUP_FIELD_FOR_CASES'] = 'Groepeer veld voor Klachten:';
...
$mod_strings['LBL_CONFIG_LOGIC_HOOKS_ENABLED_DESC'] = "'logic_hooks_enabled' toestaan logic hooks voor automatisch updaten gebaseerd op gerelateerde objecten. Het is aanbevolen dit uit te zetten wanneer je SugarCRM upgrade.";
...
$mod_strings['LBL_CONFIG_MAP_ADSENSE_REMOVAL_KEY_TITLE'] = 'Kaart AdSense verwijder licentie:';
$mod_strings['LBL_CONFIG_MAP_ADSENSE_REMOVAL_KEY_DESC'] = 'Doneer aan dit project! Neem contact op met JJWDesign.com voor een AdSense verwijder licentie.';
